...
class RegisterEmployeeView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            subject = 'welcome to Job portal world'
            message = f'Hi {firstname} {lastname}, thank you for registering in Job Portal as an Employee.'
...
class RegisterEmployerView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            lastname = form.cleaned_data['last_name']
            subject = 'welcome to Job portal world'
            message = f'Hi {firstname} {lastname}, thank you for registering in Job Portal as an Employer.'
            email_from = settings.EMAIL_HOST_USER
            recipient_list = [user.email,]
            send_mail( subject, message, email_from, recipient_list )
